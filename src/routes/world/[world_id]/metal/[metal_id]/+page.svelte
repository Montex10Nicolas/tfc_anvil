      ...
      <code>
		...
		>
			...
			>
				...
				<input
					{...bho.fields.itemName.as('text')}
					type="text"
					bind:value={item.name}
					class="rounded"
				/>
				<select
					{...bho.fields.inputItem.as('text')}
					bind:value={item.inputItemName}
					class="rounded"
				>
					{#each inputItems as value}
				...
				<div>
					<label for="">
						Last
						<select
							{...bho.fields.lastAction.as('number')}
							bind:value={
					...
					<label for="">
						Second Last
						<select
							{...bho.fields.secondAction.as('number')}
							bind:value={
					...
					<label for="">
						Third Last
						<select
							{...bho.fields.thirdAction.as('number')}
							bind:value={
				...
				<button class="cursor-pointer rounded bg-green-600 py-2 font-black text-white uppercase">
					Update
				</button>
			</form>
		</div>
